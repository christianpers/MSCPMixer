...
- (void)viewDidLoad
{
    ...
    artistLbl.backgroundColor = [UIColor clearColor];
    ...
    self.controlView.autoresizingMask = UIViewAutoresizingFlexibleRightMargin;
...
- (void)setmixerModeOn{
   ...
   // self.view.backgroundColor = [UIColor blackColor];
    self.controlView.center = CGPointMake(270, 470);
    self.artistLbl.center = CGPointMake(270, 215);
    self.titleLbl.center = CGPointMake(270, 275);
}
